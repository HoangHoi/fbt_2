...
function tour(option) {
    ...
    this.addEvent = function () {
        ...
        $('#table tbody').on('click', 'td.tour-name', function () {
...
//            current.deleteById(id);
    ...
    this.showTour = function (tourId) {
        var tourData = current.loadTour(tourId);
        
        $('#modal-show-tour').modal("show");
    };
    ...
    this.addPlace = function () {
        ...
        console.log(current.selectPlace);
    };
